...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const scrollbarMouseDownHandler = e => {
    ...
    window.addEventListener('mousedown', scrollbarMouseDownHandler);
    window.addEventListener('mouseup', scrollbarMouseUpHandler);
    ...
    return () => {
      ...
      window.removeEventListener('mousedown', scrollbarMouseDownHandler);
      window.removeEventListener('mouseup', scrollbarMouseUpHandler);
